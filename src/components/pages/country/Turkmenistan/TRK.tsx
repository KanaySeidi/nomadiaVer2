...
import mainBanner from "@/assets/img/Turkmenistan main page.png";
...
function TRK() {
  ...
  const slidesData = [
    { title: "trkm.sliderTitle1", description: "trkm.sliderDesc1" },
    { title: "trkm.sliderTitle2", description: "trkm.sliderDesc2" },
    { title: "trkm.sliderTitle3", description: "trkm.sliderDesc3" },
  ];
