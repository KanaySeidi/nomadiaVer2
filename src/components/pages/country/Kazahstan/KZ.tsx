...
import mainBanner from "@/assets/img/Kazakhstan main page.png";
...
function KZ() {
  ...
  const slidesData = [
    { title: "kazakh.sliderTitle1", description: "kazakh.sliderDesc1" },
    { title: "kazakh.sliderTitle2", description: "kazakh.sliderDesc2" },
    { title: "kazakh.sliderTitle3", description: "kazakh.sliderDesc3" },
  ];
