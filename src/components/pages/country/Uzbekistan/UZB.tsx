...
import mainBanner from "@/assets/img/Uzbekistan main page.png";
...
function UZB() {
  ...
  const slidesData = [
    { title: "uzbek.sliderTitle1", description: "uzbek.sliderDesc1" },
    { title: "uzbek.sliderTitle2", description: "uzbek.sliderDesc2" },
    { title: "uzbek.sliderTitle3", description: "uzbek.sliderDesc3" },
  ];
  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="lg:px-24 px-4  relative text-emerald-900">
        <h1 className="xl:text-5xl lg:text-3xl text-xl font-black lg:mt-40 mt-20 bg-white/40 backdrop-blur-lg text-emerald-900 w-fit p-2 rounded-lg">
          {t("Country.Uzbekistan")}
        </h1>
        <p className="xl:text-2xl lg:text-lg text-lg font-black w-fit bg-white/40 backdrop-blur-lg rounded-lg mt-3 lg:p-2 p-1 pl-0 text-emerald-900">
          {t("uzbek.slogan")}
        </p>
        <div className="flex gap-4 mt-8">
          <div className="xl:w-1/2 lg:w-3/4 md:w-3/4 sm:w-96 w-72 h-auto backdrop-blur-md p-2 pl-0 lg:text-base text-xs rounded-md text-white text-justify">
